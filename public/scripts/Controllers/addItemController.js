myApp.controller("addItemController", ['$scope', '$http', function($scope, $http){
  ...
  $scope.uploadFile = function(){
      ...
      if(file === undefined && picFromCam !== undefined){
        $http({
  ...
  $scope.init = function(){
      console.log( 'in cameraFunction' );
        ...
        take_photo_btn.addEventListener("click", function(e){
            ...
            video.pause();
            picFromCam = download_photo_btn.href.split(',')[1];
            console.log('picFromCam:', picFromCam);
        });
